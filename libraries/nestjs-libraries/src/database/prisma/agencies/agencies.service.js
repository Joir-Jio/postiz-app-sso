...
let AgenciesService = class AgenciesService {
    ...
    async approveOrDecline(email, action, id) {
        ...
        if (action === 'approve') {
            await this._notificationService.sendEmail((_a = agency === null || agency === void 0 ? void 0 : agency.user) === null || _a === void 0 ? void 0 : _a.email, 'Your Agency has been approved and added to Postiz 🚀', `
<html lang="en">
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  ...
  It will appear on the main agency of Postiz in the next 24 hours.<br /><br />
        ...
        await this._notificationService.sendEmail((_b = agency === null || agency === void 0 ? void 0 : agency.user) === null || _b === void 0 ? void 0 : _b.email, 'Your Agency has been declined 😔', `
<html lang="en">
