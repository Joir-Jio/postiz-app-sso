...
const contentZod = (isPicture, format) => {
    const content = zod_1.z.object(Object.assign({ content: zod_1.z.string().describe('Content for the new post'), website: zod_1.z
            .string()
            .nullable()
            .optional()
...
let AgentGraphService = AgentGraphService_1 = class AgentGraphService {
    ...
    async findTopic(state) {
        const allTopics = await this._postsService.findAllExistingTopicsOfCategory(state === null || state === void 0 ? void 0 : state.category);
