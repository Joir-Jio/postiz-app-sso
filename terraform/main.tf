# Terraform configuration for Postiz SSO AWS deployment
# Optimized for ECS Fargate with security best practices
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:ssm:${var.aws_region}:${data.aws_caller_identity.current.account_id}:parameter/postiz/*"
        ]
      }
    ]
  })
...
resource "aws_ssm_parameter" "db_password" {
  name  = "/postiz/database-password"
  type  = "SecureString"
  value = random_password.db_password.result
}

resource "aws_ssm_parameter" "database_url" {
  name  = "/postiz/database-url"
  type  = "SecureString"
  value = "postgresql://${aws_db_instance.main.username}:${random_password.db_password.result}@${aws_db_instance.main.endpoint}/${aws_db_instance.main.db_name}"
}

resource "aws_ssm_parameter" "redis_url" {
  name  = "/postiz/redis-url"
  type  = "SecureString"
